...
public class ModelsTests {
    ...
    @org.junit.jupiter.api.Test
    public void testInsertAndTestWhereWithTextAndCompositePrimaryKeyField() {
        // bjLoquent don't have yet a way to create a table
        // so we need to create it manually
    ...
    @org.junit.jupiter.api.Test
    public void testUpdateWithCompositePrimaryKeys() {
        // bjLoquent don't have yet a way to create a table
        // so we need to create it manually
        String createUserTableSql = "CREATE TABLE IF NOT EXISTS players (" +
                "uuid VARCHAR(255) NOT NULL, " +
        ...
        // Now we want to update the story of the first player
        firstPlayerStory.setValue("Gordon Freeman is the main caracter of Half-Life 1 and 2 and 3");
        firstPlayerStory.save();

        // Now we want to update the role of the second player
        secondPlayerRole.setValue("Rebel and Scientist");
        secondPlayerRole.save();
